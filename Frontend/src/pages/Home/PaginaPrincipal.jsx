    ...
    <Pagina>
        ...
        <div className="max-w-7xl mx-auto px-8 lg:px-14 grid grid-cols-1 lg:grid-cols-2 items-center">
          <div className="lg:pr-8 flex flex-col items-start justify-center space-y-8">
            ...
            <p className="text-gray-600 text-xl md:text-xl max-w-xl leading-7 text-justify">
              <TypingText
                text="Tecnologia avançada em neuromodulação não invasiva para tratamentos eficazes e seguros."
                speed={40}
              />
            </p>
            ...
            <div className="flex items-center space-x-4">
              <a
                href={`https://wa.me/4498322222?text=${encodeURIComponent(
                  texto
                )}`}
                className="px-6 md:px-8 py-3 md:py-4 bg-blue-600 text-white rounded-full shadow-lg hover:bg-blue-700 transition"
              >
                Faça um Orçamento &nbsp;→
              </a>
              ...
              <a
                href="/saibamais"
                className="flex items-center gap-3 px-5 py-3 rounded-full border-2 border-blue-500 text-blue-600 hover:bg-blue-50 transition"
              >
          ...
          <div className="flex justify-center lg:justify-end">
            <img src={productImg} alt="MAXIMUS EMT" className="max-h-[80vh]" />
          </div>
        </div>
      </section>
      ...
      <section className="mt-16 bg-gray-50 w-full h-full flex flex-col">
        ...
        <div className="w-full h-full flex flex-col lg:flex-row justify-between p-6 sm:p-10 text-base sm:text-lg md:text-xl lg:text-2xl text-justify">
          ...
          <div className="flex-1 lg:w-1/2 m-2 sm:m-4 flex justify-center">
            <video src="/videoplayback.mp4" controls poster="/logoMagviaComTexto.png" className="w-full max-w-xl rounded-lg shadow-md"></video>
          </div>
        </div>
      </section>
    </Pagina>
