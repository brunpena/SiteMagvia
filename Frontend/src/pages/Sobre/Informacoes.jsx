                ...
                <section className="py-20 bg-teal-50">
                    <div className="max-w-6xl mx-auto px-6 text-center">
                        ...
                        <p className="max-w-3xl mx-auto text-gray-600 text-lg sm:text-xl mb-12 text-justify">
                            O MAXIMUS EMT é utilizado em diversas especialidades médicas com
                            resultados comprovados cientificamente
                        </p>

                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 items-stretch">
                            <article className="group bg-blue-500 rounded-2xl shadow-lg transition-all duration-300 p-10 flex flex-col items-center justify-center border-2 border-transparent hover:bg-blue-50 hover:border-blue-500">
                                <div className="mb-6 p-3 rounded-full bg-white/10 transition-all duration-300 border-2 border-transparent group-hover:bg-blue-50 group-hover:border-blue-500">
                                    <Brain
                                        size={48}
                                        strokeWidth={2}
                            ...
                            <article className="group bg-teal-500 rounded-2xl shadow-lg transition-all duration-300 p-10 flex flex-col items-center justify-center border-2 border-transparent hover:bg-teal-50 hover:border-teal-500">
                                <div className="mb-6 p-3 rounded-full bg-white/10 transition-all duration-300 border-2 border-transparent group-hover:bg-teal-50 group-hover:border-teal-500">
                                    <Activity
                                        size={48}
                                        strokeWidth={2}
                                        className="text-white transition-colors duration-300 group-hover:text-teal-500"
                                    />
                                </div>
                            ...
                            <article className="group bg-purple-700 rounded-2xl shadow-lg transition-all duration-300 p-10 flex flex-col items-center justify-center border-2 border-transparent hover:bg-purple-50 hover:border-purple-700">
                                <div className="mb-6 p-3 rounded-full bg-white/10 transition-all duration-300 border-2 border-transparent group-hover:bg-purple-50 group-hover:border-purple-700">
                                    <Heart
                                        size={48}
                                        strokeWidth={2}
                ...
                <div className="max-w-6xl mx-auto px-6 text-center">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 items-stretch">
                        {cards.map((c) => {
                            ...
                            const hoverColored = `0 20px 40px ${hexToRgba(
                                c.colorHex,
                                0.2
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <h3
                                        id={`${c.id}-title`}
                                        className="text-base sm:text-lg font-bold tracking-wide uppercase text-gray-800 mb-3"
                                    >
                                        {c.title}
                                    </h3>
